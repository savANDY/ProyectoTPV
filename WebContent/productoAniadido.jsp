...
<title>TPV Bar Eguzki - Producto Añadido</title>
...
<body id="skin-blur-violate">
	...
	<div class="block-area">
		<div class="alert alert-success">
			¡Producto "<%=producto.getNombre()%>" añadido con exito!
		</div>
	</div>
	...
	<div class="block-area">
		...
		<a href="nuevoProducto.jsp" class="btn btn-default" role="button">Volver</a>
	</div>
	<%
		}
